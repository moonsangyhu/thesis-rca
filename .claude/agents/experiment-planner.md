...
**이 단계를 건너뛰지 않는다.** WebSearch로 최근 3년(2023-2026) AIOps + LLM 논문을 조사한다.

#### 검색 키워드
- "LLM root cause analysis kubernetes" 2023-2026
- "AIOps large language model cloud" 2023-2026
- "automated incident diagnosis microservices" 2023-2026
- "context engineering LLM operations" 2023-2026
- "prompt optimization root cause analysis" 2023-2026

#### 수집 정보 (논문당)
- 제목, 저자, 연도, 학회/저널
- 핵심 기법 (프롬프트 최적화, RAG 개선, 컨텍스트 엔지니어링 등)
- 보고된 성능 개선 효과 (정확도 향상 수치)
- 본 실험에 적용 가능한 인사이트
