#!/usr/bin/env python3
"""
v2 실험 실행: 힌트 제거 + Chain-of-Thought.
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler(RESULTS_DIR / "experiment_v2.log"),
    ],
)
...
def main():
    parser = argparse.ArgumentParser(description="v2 RCA experiment: no hints + CoT")
    ...
    if args.dry_run:
        ...
        engine = RCAEngineV2(model=args.model, provider=args.provider)
    ...
    logger.info("v2 experiment: %d trials (%s × %s)", total, faults, trials)
