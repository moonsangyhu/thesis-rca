"""v3 RCA engine: CoT + bilingual + evidence chain + Evaluator + Retry harness."""
import json
import logging
import time
...
class RCAEngineV3(BaseLLMClient):
    """v3: 힌트 없음, 풀 CoT, bilingual, evidence chain, Evaluator + Retry harness."""
