"""v6 RCA engine: SOP-Guided Diagnosis Prompt (V3 fork, prompt only changed)."""
import json
import logging
import time
...
class RCAEngineV6(BaseLLMClient):
    """v6: SOP-Guided Diagnosis — V3 engine with SOP system prompt."""
