"""v10 experiment configuration: Pre-Trial State Validator (V8 fork).

V10 단일 독립변수: validator. 프롬프트/엔진 로직/메트릭 수집은 V8와 완전 동일.
plan: docs/plans/experiment_plan_v10.md (1차 리비전 후, review_v10 필수 5건 반영).
"""
from pathlib import Path

PROJECT_ROOT = Path(__file__).parent.parent.parent
RESULTS_DIR = PROJECT_ROOT / "results"
RESULTS_CSV = RESULTS_DIR / "experiment_results_v10.csv"
RAW_DIR = RESULTS_DIR / "raw_v10"
GROUND_TRUTH_CSV = RESULTS_DIR / "ground_truth.csv"

MAX_TOKENS = 2048
MAX_RETRIES = 2

# V10 추가 컬럼 (plan §3-3 + 필수 수정 4): skipped 처리용
CSV_HEADERS = [
